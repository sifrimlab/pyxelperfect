...
def stardistSegment(img: np.array, model:str = "2D_versatile_fluo",show_dist=True) -> np.array:
...
def cellposeSegment(img: np.array, model:str = "2D_versatile_fluo",show_dist=True)
